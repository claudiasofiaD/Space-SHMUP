...
public class Enemy_3 : Enemy
{
    ...
    // Again, Start works well because it is not used in the Ene,y superclass
    void Start() {
        points = new Vector3[3];    // Intantialize points
        ...
        // Pick a random final position above teh top of the screen
    ...
    public override void Move() {
        ...
        transform.rotation  = Quaternion.Euler( u * 100, 0, 0 );
